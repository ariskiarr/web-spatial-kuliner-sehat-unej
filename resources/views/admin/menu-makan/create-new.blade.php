...
<head>
    ...
    <title>Tambah Menu - {{ $tempatMakan->nama_tempat }}</title>
...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <div class="info-box">
                ...
                <ul>
                    <li>Isi nama menu dengan lengkap dan jelas</li>
                    <li>Masukkan harga dalam rupiah (tanpa desimal)</li>
                    <li>Kalori bisa dihitung otomatis atau input manual</li>
                    <li>Fitur auto-kalori menggunakan AI untuk estimasi</li>
                </ul>
            </div>

            <form action="{{ route('admin.menu-makan.store', $tempatMakan->id) }}" method="POST" id="menuForm">
                @csrf
                ...
                <div class="section section-kalori">
                    ...
                    <div class="form-help" style="text-align: center; margin-bottom: 20px;">
                        Sistem akan mengestimasi kalori berdasarkan nama menu menggunakan AI
                    </div>
                    ...
                    <div class="kalori-input-section">
                        <div class="form-group">
                            ...
                            <div class="form-help">Opsional: Bisa diisi manual atau menggunakan estimasi otomatis</div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.getElementById('btnAutoKalori').addEventListener('click', function() {
            ...
            btn.disabled = true;
            btn.innerHTML = '<span class="spinner"></span> Menghitung kalori...';
